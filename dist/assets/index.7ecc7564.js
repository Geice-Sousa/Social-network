...
const login = () => {
  ...
  <div class="container-bcg-login">   
    <div class="bckgnd-txt-img">
      <img class="img-apresentacao" src="./imagens/background login.png" alt="dois cachos de uva diagonalmente opostos com o nome m\xE3es e vinhos entre ele">
  ...
  <div class="footer-login-desktop">
    <img class="imagem-footer-login " src="../imagens/brinde_ta\xE7as-removebg-preview.png" alt="duas m\xE3os pr\xF3ximas segurando ta\xE7as com vinho simulando um brinde">
  </div>
  `;
...
const postagem = () => {
  ...
  <div class="imagem-postagem-desktop">
    <img class="logo-desktop" src="imagens/nome logo.png" alt="nome m\xE3es e vinhos logo">

    <img class="img-desktop" src="imagens/enchendo_ta\xE7a_de_vinho-removebg-preview.png" alt="imagem  de garrafa derramand liquido em uma ta\xE7a">
  </div>
